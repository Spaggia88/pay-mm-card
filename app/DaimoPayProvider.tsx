...
export function DPProvider ({ children }: { children: React.ReactNode }) {
  return (
    <WagmiProvider config={config}>
        <DaimoPayProvider debugMode customTheme={customTheme} >{children}</DaimoPayProvider>
    </WagmiProvider>
  );
};

// See https://paydocs.daimo.com/sdk#themes-and-customization
// and https://docs.family.co/connectkit/theme-builder
const customTheme = {
  "--ck-font-family": "Euclid Circular B",
  "--ck-font-weight": "400",
  ...
  "--ck-overlay-background": "#00000090",
